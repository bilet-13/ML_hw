   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      " 1214 1 \n",
      " 5 1217\n",
      "Classification accuracy: 0.9975379565038982\n",
      "Sensitivity: 0.9991769547325103\n",
      ...
      " 1214 106 \n",
      " 5 1112\n",
      "Classification accuracy: 0.9544521953221173\n",
      "Sensitivity: 0.9196969696969697\n",
      "Precision: 0.9958982772764561\n",
      "\n",
      "K-fold cross-validation without laplace\n",
      "confusion matrix:\n",
      " 1395.3333333333333 1.0 \n",
      " 7.333333333333333 1304.3333333333333\n",
      "Classification accuracy: 0.9969226981782374\n",
      "Sensitivity: 0.9992834153247578\n",
      "Precision: 0.9947846974365211\n",
      "\n",
      "K-fold cross-validation with laplace\n",
      "confusion matrix:\n",
      " 1395.0 103.66666666666667 \n",
      " 7.666666666666667 1201.6666666666667\n",
      "Classification accuracy: 0.9588872476612506\n",
      "Sensitivity: 0.930713275573941\n",
      "Precision: 0.9945530550923006\n"
     ]
    }
   ],
   "source": [
